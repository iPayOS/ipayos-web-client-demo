                ...
                <div class="col-xs-12 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="ncc_card_init.php">
                                ...
                                <div class="form-group">
                                    <label for="amount">
                                        Card Type</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="type" name="type" placeholder="Enter card type"
                                            required autofocus />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8 col-sm-offset-4">
                                        <button type="submit" name="pay" class="btn btn-success">Store</button>
                                    </div>
                                </div>
                            </form>
                        </div>
